        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:items-start xl:gap-14">
          <div className="lg:col-span-7">
            ...
            <SectionReveal delay={200}>
              <p className="mt-6 max-w-3xl text-xl text-muted-foreground leading-relaxed">{item.excerpt}</p>
            </SectionReveal>
          </div>
      ...
      <div className="container-page mt-16">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-start xl:gap-14">
          <div className="lg:col-span-7 xl:col-span-8">
            <SectionReveal>
              <div className="max-w-3xl text-lg text-foreground/90 leading-relaxed whitespace-pre-line">{item.content}</div>
            </SectionReveal>
          </div>
