  ...
  head: () => ({
    meta: [
      { title: "UNIJUI Living Labs — Inovação Aberta em Agro e Smart Cities" },
      {
        name: "description",
        content:
          "Portal dos Living Labs Agro e Smart Cities da UNIJUI. Projetos, notícias e pesquisa aberta.",
      },
      { property: "og:title", content: "UNIJUI Living Labs" },
      {
        property: "og:description",
        content: "Inovação aberta em Agro e Smart Cities, a partir do interior do RS.",
      },
        ...
        <div className="container-page">
          ...
          <SectionReveal delay={280}>
            <p className="mt-8 max-w-2xl text-lg md:text-xl text-muted-foreground leading-relaxed">
              Dois laboratórios vivos da Universidade Regional do Noroeste do Estado do RS,
              conectando ciência, comunidade e tecnologia.
            </p>
          </SectionReveal>
          <SectionReveal delay={440}>
            <div className="mt-10 flex flex-wrap gap-3">
              <Link
                to="/projetos"
                className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-foreground text-background text-sm font-medium hover-lift"
              >
                Conheça os projetos <ArrowRight className="size-4" />
              </Link>
              <Link
                to="/sobre"
                className="inline-flex items-center gap-2 px-5 py-3 rounded-full border border-border text-sm font-medium hover-lift"
              >
          ...
          <div className="rounded-3xl border border-border p-10 md:p-16 bg-card flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div>
              ...
              <p className="mt-3 text-muted-foreground max-w-xl">
                Parcerias com empresas, prefeituras, cooperativas e demais universidades são
                bem-vindas.
              </p>
            </div>
            <Link
              to="/contato"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-foreground text-background text-sm font-medium hover-lift self-start"
            >
