...
export const Route = createFileRoute("/equipe")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conheça as pessoas por trás dos Living Labs Agro e Smart Cities da UNIJUI." },
      { property: "og:title", content: "Equipe — UNIJUI Living Labs" },
      { property: "og:description", content: "Pesquisadores, coordenadores e bolsistas dos labs UNIJUI." },
...
function EquipePage() {
  ...
  return (
    <section className="container-page pt-20 md:pt-28 pb-24">
      <SectionReveal><span className="eyebrow">Equipe</span></SectionReveal>
      ...
      <div key={filter} className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 animate-[fade-in_0.5s_ease-out]">
        {list.map((m, i) => (
